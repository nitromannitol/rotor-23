...
Status: **33 frozen nodes — 2 `CONDITIONAL`, 2 `DRAFT_SORRY`, 7 `FROZEN`, 22 `SEALED`.**  The 31 sealed nodes are machine-checked and no
sealed node's axiom closure contains `sorryAx`.  Still open: `prop-square-passage`, `lem-square-constrained-bonds`,

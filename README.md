...
Status: **33 frozen nodes — 11 `DRAFT_SORRY`, 7 `FROZEN`, 15 `SEALED`.**  The 22 sealed nodes are machine-checked and no
sealed node's axiom closure contains `sorryAx`.  Still open: `thm-main-square`, `thm-main-degree-three`, `prop-perturbations-square`, `prop-perturbations-degree-three`, `prop-square-passage`, `lem-square-dual-path`, `lem-square-constrained-bonds`, `lem-square-exploration`, `lem-square-active-list`, `lem-square-forced-tests`, `prop-pendant-counterexample`,

...
Status: **33 frozen nodes — 2 `CONDITIONAL`, 6 `DRAFT_SORRY`, 7 `FROZEN`, 18 `SEALED`.**  The 27 sealed nodes are machine-checked and no
sealed node's axiom closure contains `sorryAx`.  Still open: `prop-square-passage`, `lem-square-constrained-bonds`, `lem-square-exploration`, `lem-square-active-list`, `lem-square-forced-tests`, `prop-pendant-counterexample`,

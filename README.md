...
Status: **33 frozen nodes — 3 `CONDITIONAL`, 1 `DRAFT_SORRY`, 7 `FROZEN`, 22 `SEALED`.**  The 32 sealed nodes are machine-checked and no
sealed node's axiom closure contains `sorryAx`.  Still open: `lem-square-constrained-bonds`,

...
Status: **33 frozen nodes — 2 `CONDITIONAL`, 3 `DRAFT_SORRY`, 7 `FROZEN`, 21 `SEALED`.**  The 30 sealed nodes are machine-checked and no
sealed node's axiom closure contains `sorryAx`.  Still open: `prop-square-passage`, `lem-square-constrained-bonds`, `lem-square-forced-tests`,

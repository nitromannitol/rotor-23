...
Status: **33 frozen nodes — 12 `DRAFT_SORRY`, 7 `FROZEN`, 14 `SEALED`.**  The 21 sealed nodes are machine-checked and no
sealed node's axiom closure contains `sorryAx`.  Still open: `thm-main-square`, `thm-main-degree-three`, `prop-perturbations-square`, `prop-perturbations-degree-three`, `prop-subcubic-recurrence`, `prop-square-passage`, `lem-square-dual-path`, `lem-square-constrained-bonds`, `lem-square-exploration`, `lem-square-active-list`, `lem-square-forced-tests`, `prop-pendant-counterexample`,

...
Status: **33 frozen nodes — 2 `CONDITIONAL`, 5 `DRAFT_SORRY`, 7 `FROZEN`, 19 `SEALED`.**  The 28 sealed nodes are machine-checked and no
sealed node's axiom closure contains `sorryAx`.  Still open: `prop-square-passage`, `lem-square-constrained-bonds`, `lem-square-exploration`, `lem-square-active-list`, `lem-square-forced-tests`,

...
Status: **27 frozen nodes — 18 `DRAFT_SORRY`, 7 `FROZEN`, 2 `SEALED`.**  The 9 sealed nodes are machine-checked and no
sealed node's axiom closure contains `sorryAx`.  Still open: `lem-boundary-routing`, `prop-circuit-iterate`, `prop-monotonicity`, `prop-passage`, `lem-decreasing-positions`, `prop-live-recurrence`, `prop-path-reduction`, `prop-passage-limit`, `prop-circuit-shape`, `prop-circuit-clock`, `lem-block-live-paths`, `thm-main-square`, `thm-main-degree-three`, `prop-perturbations-square`, `prop-perturbations-degree-three`, `prop-subcubic-recurrence`, `prop-degree-three-passage`, `prop-square-passage`,

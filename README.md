...
Status: **33 frozen nodes — 24 `DRAFT_SORRY`, 7 `FROZEN`, 2 `SEALED`.**  The 9 sealed nodes are machine-checked and no
sealed node's axiom closure contains `sorryAx`.  Still open: `lem-boundary-routing`, `prop-circuit-iterate`, `prop-monotonicity`, `prop-passage`, `lem-decreasing-positions`, `prop-live-recurrence`, `prop-path-reduction`, `prop-passage-limit`, `prop-circuit-shape`, `lem-block-live-paths`, `thm-main-square`, `thm-main-degree-three`, `prop-perturbations-square`, `prop-perturbations-degree-three`, `prop-subcubic-recurrence`, `prop-degree-three-passage`, `prop-square-passage`, `lem-square-dual-path`, `lem-square-constrained-bonds`, `prop-circuit-clock`, `lem-square-exploration`, `lem-square-active-list`, `lem-square-forced-tests`, `prop-pendant-counterexample`,
